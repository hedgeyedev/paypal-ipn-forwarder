...
When(/^the computer polls the server to retrieve an IPN$/) do
  pending # express the regexp above with the code you wish you had
end
...
Given(/^that the server has an IPN available to a computer$/) do
  pending # express the regexp above with the code you wish you had
end

When(/^the computer does not poll the server$/) do
  pending # express the regexp above with the code you wish you had
end
